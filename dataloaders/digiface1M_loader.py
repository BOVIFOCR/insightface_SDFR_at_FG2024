...
class DigiFace1M_loader(Dataset):
    def __init__(self, root_dir, transform=None, other_dataset=None):
        super(DigiFace1M_loader, self).__init__()
        ...
        self.path_files = self.append_dataset_name(self.path_files, dataset_name='DigiFace-1M_500Kimg')
    ...
    def get_subj_dicts(self, path_files):
        ...
        for i, (path_file, dataset_name) in enumerate(path_files):         # '/datasets1/bjgbiesseck/SDFR_at_FG2024/datasets/synthetic/DigiFace-1M_500Kimg_100Kids_5imgs-id/images/100000/0.png'
            subjs_list[i] = dataset_name + '_' + path_file.split('/')[-2]  # 'DigiFace-1M_500Kimg_100000'
    ...
    def make_samples_list_with_labels(self, path_files, subjs_list, subjs_dict):
        ...
        for i, (path_file, dataset_name) in enumerate(path_files):        # '/datasets1/bjgbiesseck/SDFR_at_FG2024/datasets/synthetic/DigiFace-1M_500Kimg_100Kids_5imgs-id/images/100000/0.png'
            subj = dataset_name + '_' + path_file.split('/')[-2]          # 'DigiFace-1M_500Kimg_100000'
