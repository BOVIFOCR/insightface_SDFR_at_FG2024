...
class GANDiffFace_loader(Dataset):
    def __init__(self, root_dir, transform=None, other_dataset=None):
        ...
        self.path_files = self.append_dataset_name(self.path_files, dataset_name='gandiff')
    ...
    def get_subj_race_gender_dicts(self, path_files):
        ...
        for i, (path_file, dataset_name) in enumerate(path_files):        # '/datasets2/frcsyn_wacv2024/datasets/synthetic/GANDiffFace/images_crops_112x112/White_Male/7381461/49.png'
            subjs_list[i] = dataset_name + '_' + path_file.split('/')[-2] # 'gandiff_7381461'
    ...
    def make_samples_list_with_labels(self, path_files, subjs_list, subjs_dict, races_dict, genders_dict):
        ...
        for i, (path_file, dataset_name) in enumerate(path_files):    # '/datasets2/frcsyn_wacv2024/datasets/synthetic/GANDiffFace/images_crops_112x112/White_Male/7381461/49.png'
            subj = dataset_name + '_' + path_file.split('/')[-2]      # 'gandiff_7381461'
...
#     root_dir = '/nobackup/unico/frcsyn_wacv2024/datasets/synthetic/GANDiffFace/images_crops_112x112'
#     transform=None
#     print('Loading gandiff paths...')
#     train_set = GANDiffFace_loader(root_dir, transform, None)
...
if __name__ == '__main__':
    ...
    print('Loading gandiff paths...')
    transform=None
    train_set = GANDiffFace_loader(root_dir, transform, train_set)
