...
# config.alfa_discrim = 1.5

config.resume = False
config.output = None
config.embedding_size = 512
config.embedding_size_discrim = 256
...
if uname.nodename == 'duo':
    ...
    config.rec = ['/home/bjgbiesseck/datasets/real/1_CASIA-WebFace/imgs_crops_112x112', '/home/bjgbiesseck/datasets/synthetic/DCFace/dcface_wacv/organized']
...
config.wandb_project = "R100_CASIA-Webface_DCFace_Multi-task-Adv_20572classes_whole_dataset"
