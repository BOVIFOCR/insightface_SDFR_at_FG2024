...
if uname.nodename == 'duo':
    ...
    config.rec = '/datasets1/bjgbiesseck/SDFR_at_FG2024/datasets/synthetic/dcface_0.5m_oversample_xid/record'     # duo
    # config.rec = '/datasets1/bjgbiesseck/MS-Celeb-1M/faces_emore'
...
config.wandb_project = "R50_SDFR2024_DCFace_10000classes_whole_dataset"
