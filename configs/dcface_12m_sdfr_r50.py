...
if uname.nodename == 'duo':
    ...
    config.rec = '/datasets1/bjgbiesseck/SDFR_at_FG2024/datasets/synthetic/dcface_1.2m_oversample_xid/record'     # duo
...
config.wandb_project = "R50_SDFR2024_DCFace_60000classes_whole_dataset"
